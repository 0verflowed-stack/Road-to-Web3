...
export default function Home() {
  ...
  return (
    <div className={styles.container}>
      <Head>
        <title>Buy ThatScientist a Coffee!</title>
          ...
          <div>
            <form>
              ...
              <div>
                <button
                  type="button"
                  onClick={async () => await buyCoffee(false)}
                >
      ...
      {currentAccount && (memos.map((memo, idx) => {
        return (
          <div key={idx} style={{border:"2px solid", "borderRadius":"5px", padding: "5px", margin: "5px"}}>
            ...
            <p>Bought {memo.isLargeCoffee ? "large" : ""} coffee</p>
          </div>
        )
      }))}
      <footer className={styles.footer}>
        ...
        >
          Created by ThatScientist for Alchemy's Road to Web3 lesson two!
        </a>
      </footer>
    </div>
  )
